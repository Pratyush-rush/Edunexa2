...
export default function LoginPage() {
  ...
  async function handleSignUp(e: React.FormEvent) {
    ...
    const assignedAdminCode = role === "admin" ? generateAdminCode() : null;
    ...
    // Students must provide their own registration number
    if (role === "student") {
    ...
    const signupRes = await fetch("/api/auth/signup", {
      ...
      body: JSON.stringify({
        ...
        role,
        adminCode: assignedAdminCode || enteredCode,
        registrationNo: role === "student" ? registrationNo.trim() : null,
      }),
    });
    ...
    if (role === "admin" && assignedAdminCode) {
      // Show the admin code reveal screen
      setCreatedAdminCode(assignedAdminCode);
